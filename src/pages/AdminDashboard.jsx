            ...
            <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-slate-50/50">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">Kelola campaign, user, dan aktivitas donasi.</p>
                    </div>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8" id="adminSummary">
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <p className="text-sm font-medium text-slate-500 mb-1">Total Users</p>
                        <h3 className="text-3xl font-bold text-slate-900">0</h3>
                    </div>
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <p className="text-sm font-medium text-slate-500 mb-1">Users Aktif</p>
                        <h3 className="text-3xl font-bold text-slate-900">0</h3>
                    </div>
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <p className="text-sm font-medium text-slate-500 mb-1">Campaign Pending</p>
                        <h3 className="text-3xl font-bold text-slate-900">0</h3>
                    </div>
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <p className="text-sm font-medium text-slate-500 mb-1">Total Donasi</p>
                        <h3 className="text-3xl font-bold text-slate-900">Rp 0</h3>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-bold text-slate-900">Persetujuan Campaign</h2>
                            <span className="text-xs text-slate-400">Klik approve/reject untuk mengubah status</span>
                        </div>
                        <div className="space-y-4" id="adminCampaignList">
                            <div className="text-center py-8 bg-slate-50 rounded-2xl border border-slate-100">
                                ...
                                <p className="text-slate-500 font-medium">Memuat data campaign...</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-bold text-slate-900">Manajemen User</h2>
                            <span className="text-xs text-slate-400">Ubah role dan status akun</span>
                        </div>
                        <div className="space-y-4" id="adminUserList">
                            <div className="text-center py-8 bg-slate-50 rounded-2xl border border-slate-100">
                                <div className="animate-spin rounded-full h-8 w-8 border-4 border-primary-500 border-t-transparent mx-auto mb-3"></div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-bold text-slate-900">Riwayat Donasi</h2>
                        <span className="text-xs text-slate-400">Terbaru</span>
                    </div>
                    <div className="space-y-4" id="adminDonationList">
                        <div className="text-center py-8 bg-slate-50 rounded-2xl border border-slate-100">
                            <div className="animate-spin rounded-full h-8 w-8 border-4 border-primary-500 border-t-transparent mx-auto mb-3"></div>
