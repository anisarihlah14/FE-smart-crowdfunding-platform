...
<aside className="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col flex-shrink-0 z-10 shadow-sm">
    ...
    <div className="p-4 flex-1 overflow-y-auto">
        ...
        <nav className="space-y-1">
            ...
            <Link to="/riwayat-donasi" className="flex items-center px-3 py-2.5 rounded-lg font-medium transition-colors bg-primary-50 text-primary-700">
            ...
            <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-slate-50/50">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">Lihat semua donasi yang pernah Anda lakukan.</p>
                    </div>
                    <Link to="/dashboard" className="mt-4 sm:mt-0 text-sm font-semibold text-primary-600 hover:text-primary-700 flex items-center">
                        Kembali ke Dashboard <i className="ph ph-arrow-right ml-1"></i>
                    </Link>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-sm font-medium text-slate-500 mb-1">Total Donasi</p>
                                <h3 className="text-3xl font-bold text-slate-900" id="donation-total">Rp 0</h3>
                            </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-sm font-medium text-slate-500 mb-1">Jumlah Transaksi</p>
                                <h3 className="text-3xl font-bold text-slate-900" id="donation-count">0</h3>
                            </div>
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                        <div className="flex justify-between items-start">
                            <div>
                                <p className="text-sm font-medium text-slate-500 mb-1">Campaign Didukung</p>
                                <h3 className="text-3xl font-bold text-slate-900" id="donation-campaigns">0</h3>
                            </div>
                ...
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-5">
                        <h2 className="text-lg font-bold text-slate-900">Daftar Donasi</h2>
                    ...
                    <div className="space-y-4" id="donationHistoryList">
                        <div className="text-center py-10 bg-slate-50 rounded-2xl border border-slate-100">
                            ...
                            <p className="text-slate-500 font-medium">Memuat riwayat donasi...</p>
                        </div>
                    </div>
                </div>
            </main>
